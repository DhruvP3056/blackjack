        ...
        do {
            try {
                ...
                if (option == 1) {
                    ...
                    System.out.println("In Super BlackJack there is a new kind of card in play, the Joker. Jokers have a value of 1000 and if you get\n"
                            + "one, you lose automatically.");
