...
public class BlackjackUI {
    ...
    public void didDealerWin(Deck dealerCards, Deck playingDeck, ArrayList<Deck> playersDeck){
    ...
    public void isBusted(Deck dealerCards, ArrayList<Deck> playersDeck){
        System.out.println("Dealer's Hand Value is " + dealerCards.cardsValue());
    ...
    public void winChecker(Deck dealerCards, ArrayList<Deck> playersDeck){
        for(int i = 0; i < players.size(); i++){
    ...
    public void moneyUpdate(ArrayList<StandardPlayer> players){
        for(StandardPlayer player: players){
            System.out.println("/nNew Balance for " + player.getName() + "is ");
